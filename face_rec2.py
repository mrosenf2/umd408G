...
def predict(X_img=None, knn_clf=None, model_path=None, distance_threshold=0.6,prefound_encodings=None, voters=1):
    """
...
if __name__ == "__main__":
    ...
    # for image_file in os.listdir("D:/School/Notes/408G/Final Project/face_detector/knn_examples/test"):
    #     full_file_path = os.path.join("D:/School/Notes/408G/Final Project/face_detector/knn_examples/test", image_file)
    ...
    #         cv2.putText(image, name, (left,int((top+bottom)/2)), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 0, 255), 2)
...
cv2.destroyAllWindows()
        ...
        #show_prediction_labels_on_image(os.path.join("D:/School/Notes/408G/Final Project/face_detector/knn_examples/test", image_file), predictions)